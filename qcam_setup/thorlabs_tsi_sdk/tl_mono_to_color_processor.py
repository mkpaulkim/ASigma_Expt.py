...
class MonoToColorProcessorSDK(object):
    ...
    def create_mono_to_color_processor(self, camera_sensor_type, color_filter_array_phase, color_correction_matrix,
        ...
        # typ: (SENSOR_TYPE, FILTER_ARRAY_PHASE, np.array, np.array, int) -> MonoToColorProcessor
        """
        Creates a MonoToColorProcessor object using the given parameters.

        :parameter: - **camera_sensor_type** (:ref:`SENSOR_TYPE<Ref-SENSOR_TYPE>`) - The sensor typ used by the camera. Use the property :ref:`TLCamera.camera_sensor_type<Ref-TLCamera-camera_sensor_type>` to get this information from a camera.
...
class MonoToColorProcessor(object):
    ...
    def _create(cls, sdk, mono_to_color_processor_handle):
        # typ: (Any, Any) -> MonoToColorProcessor
    ...
    def camera_sensor_type(self):
        ...
        The sensor typ of the camera (monochrome, bayer, etc...). This value is passed in during construction and may
